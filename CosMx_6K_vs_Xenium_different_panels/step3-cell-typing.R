...
for (i in 1:nrow(sample_list)) {
	...
	panel$intersect$threeway <- intersect(panel$intersect$sc_smi, panel$xen$rna) # Intersect of SMI, Xenium, scSeq
...
fwrite(summary, "comparison/CosMx4_UC_ct_prop_summary.txt", sep = "\t")
