...
for (i in 1:nrow(sample_list)) {
	...
	xen_unFilter <- readRDS(paste0("~/", as.character(sample_id), "_xen_so_unQVfiltered.RDS"))
	...
	xen_unFilter <- FindVariableFeatures(xen_unFilter, selection.method = "vst", nfeatures = 3000)
